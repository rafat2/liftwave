//============================================================================
// Name        : lwtimagetest.cpp
// Author      : Rafat Hussain
// Version     :
// Copyright   :
// Description : Lifting WT of arbitrary size image
//============================================================================
...
int main() {
	...
	string nm = "db3";
	liftscheme lift(nm);
	lwt2<double> wt(vec1,rows,cols,lift);
...
//	filtcoef(nm,l1,h1,l2,h2);
	...
	imgSize.width = vec[1]+vec[3];
	imgSize.height = vec[0]+vec[4];
